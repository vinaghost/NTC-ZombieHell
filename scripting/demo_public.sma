...
public plugin_init() {
	register_plugin( "Zombie Hell: Demo Recoder", "1.5", "IzI" );
...
public Record( id ) {
	...
	client_cmd( id, "stop; record ^"NTC_ZombieHell^"");
	client_mau( id, "!g[Thông báo] !yChú ý server có ghi lại demo. Tên demo là !g^"NTC_ZombieHell.dem^"");
